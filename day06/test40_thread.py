...
class BackWorker(QThread): # PyQt에서 스레드 클래스 상속
    ...
    def run(self) -> None: # Thread 실행
        ...
        ###self.parent.pgbTask.setValue(0) # 프로그레스바 0부터 시작 !!Qhread에선 UI관련된 처리르 할 수 없음
        ###self.parent.pgbTask.setRange(0, maxVal)
...
class qtwin_exam(QWidget): # QWidget을 상속받음
    ...
    @pyqtSlot(str) # BackWorker 스레드에서 self.setLogemit() 동작해서 실행
